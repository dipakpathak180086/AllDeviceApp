    ...
    public class SettingActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                editMPrinterIp = FindViewById<EditText>(Resource.Id.txtMPrinterIp);
            ...
            try
            {
                if (ValidateControls())
                {
                    ...
                    using (var streamWriter = new StreamWriter(filename, false))
                    {
                        ...
                        streamWriter.WriteLine(editMPrinterIp.Text.Trim());
                        ...
                        clsGlobal.mMachingPrinterIp = editMPrinterIp.Text.Trim();
        ...
        private void ReadSettingFile()
        {
            ...
            try
            {
                ...
                if (File.Exists(filename))
                {
                    ...
                    editMPrinterIp.Text = sr.ReadLine();
        ...
        private bool ValidateControls()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(editMPrinterIp.Text.Trim()))
                {
                    Toast.MakeText(this, "Input Machining Printer IP", ToastLength.Long).Show();
                    editMPrinterIp.RequestFocus();
                    IsValidate = false;
                }
                return IsValidate;
            }
