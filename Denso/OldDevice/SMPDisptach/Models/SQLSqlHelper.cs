...
/*
* ========================================================================================
* Procedure/Module         :   Sql Helper
* Purpose                  :   The SqlHelper class is intended to encapsulate 
*                               high performance, scalable best practices for common uses of SqlClient
* Author                   :   Dipak
* Initial Implementation   :   17/04/11
* Change 1:                :   
* Change 1: Remarks        :
* Change 2:                :   
* Change 2: Remarks        :
...
namespace SQLLib
{
    public class SqlHelper
    {
        ...
        ///' 
        //'Public  conStringbcil As String = System.Configuration.ConfigurationManager.AppSettings("conStringbcil")
