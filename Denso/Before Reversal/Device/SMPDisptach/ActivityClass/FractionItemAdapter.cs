...
namespace SMPDisptach
{
    ...
    public class FractionItemAdapter : RecyclerView.Adapter
    {
        private int mSelectedItem = -1;
        public event EventHandler<int> btnCheck;
        private Context context;
        public List<ViewFraction> data;
        LayoutInflater inflater = null;

        public FractionItemAdapter(Context context, List<ViewFraction> models)
        {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            try
            {
                View itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.ViewFractionScanningData, parent, false);
