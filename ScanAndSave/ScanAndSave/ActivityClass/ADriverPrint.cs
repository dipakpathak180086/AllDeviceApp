...
{
    public static class ADriverPrint
    {


        // Structure and i declarions:
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
        {
            ...
            try
            {
                ...
                if (bSuccess == false)
                {
                    ...
                    EndDocPrinter(hPrinter);
                    ClosePrinter(hPrinter);
                    throw new Exception(("Printer Error: " + dwError.ToString()).Replace("28", "The printer is out of paper."));
                }
                else
                {
                    EndDocPrinter(hPrinter);
        ...
        //public static void FillServerPrinterList(DropDownList dropDownList)
        //{
        //    dropDownList.Items.Clear();
        //    dropDownList.Items.Add("");
        //    foreach (var print in System.Drawing.Printing.PrinterSettings.InstalledPrinters)
        //    {
        //        dropDownList.Items.Add(print.ToString());
        //    }
        //}

    }
    public class AIPPrint
    {
        ...
        public AIPPrint(byte[] fileData, string printerIPAddress, int portNumber = 9100)
        {
            FileData = fileData;
        ...
        public AIPPrint(string printData, string printerIPAddress, int portNumber = 9100)
        {

            FileData = Encoding.ASCII.GetBytes(printData);
            PortNumber = portNumber;
            if (!IPAddress.TryParse(printerIPAddress, out PrinterIPAddress))
                throw new Exception("Wrong IP Address!");
        }
        public AIPPrint(byte[] fileData, IPAddress printerIPAddress, int portNumber = 9100)
        {
            FileData = fileData;
            PortNumber = portNumber;
        ...
        public bool PrintData()
        {
            ...
            //    throw new Exception("Could not reach to Printer");
