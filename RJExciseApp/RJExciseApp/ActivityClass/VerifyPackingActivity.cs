...
{
    [Activity(Label = "Packing Verify", WindowSoftInputMode = SoftInput.StateHidden, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation, ScreenOrientation = ScreenOrientation.Portrait)]
        ...
        private void txtScanBottelBarcode_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.Event.Action == KeyEventActions.Down)
                {
                    ...
                    {
                        lblMsg.Text = "";
                        if (txtScanBottelBarcode.Text.Length != 12)
                        {
        ...
        private void txtScanBarcode_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.Event.Action == KeyEventActions.Down)
                {
                    ...
                    {
                        lblMsg.Text = "";
                        if (txtScanCaseBarcode.Text.Length != 30)
                        {
                            lblMsg.Text = "Invalid Barcode!!!";
                            lblMsg.SetTextColor(Android.Graphics.Color.Red);
                            txtScanCaseBarcode.Text = "";
