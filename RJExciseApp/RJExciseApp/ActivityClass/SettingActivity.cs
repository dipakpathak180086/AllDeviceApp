...
namespace RJExciseApp.ActivityClass
{
    ...
    public class SettingActivity : Activity
    {
            ...
            try
            {
                if (ValidateControls())
                {
                    ...
                    using (var streamWriter = new StreamWriter(filename, false))
                    {
                        ...
                        clsGlobal.LineId = editLine.Text.Trim();
        ...
        private bool ValidateControls()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(editLine.Text.Trim()))
                {
                    Toast.MakeText(this, "Input Line", ToastLength.Long).Show();
