...
namespace BatteryDispatchScannerOnline
{
    ...
    public class BatteryScanningMainActivity : AppCompatActivity
    {
        clsGlobal clsGLB;
        //ModNet modnet;
       ...
       // Vibrator vibrator;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetContentView(Resource.Layout.activity_MainBatteryScanning);
        ...
        private void TxtDeliveryNo_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.Event.Action == KeyEventActions.Down)
                {
                    ...
                    {
                        if (txtDeliveryNo.Text.Length != 8)
                        {
                        ...
                        if (txtDeliveryNo.Text.Length > 0)
                        {
                            ...
                            this.Finish();
                            OpenActivity(typeof(BatteryScanning));
                        }
                    }
                    else
                        e.Handled = false;
