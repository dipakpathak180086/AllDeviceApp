...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Hsm.Barcode.IDecoderListenerImplementor, DeviceAPI", DecoderListenerImplementor.class, __md_methods);
	}
	...
	public DecoderListenerImplementor ()
	{
		...
		if (getClass () == DecoderListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Hsm.Barcode.IDecoderListenerImplementor, DeviceAPI", "", this, new java.lang.Object[] {  });
	}
